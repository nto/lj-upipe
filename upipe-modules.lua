...
char const *upipe_rate_limit_command_str(int);
int upipe_rate_limit_set_limit(struct upipe *, uint64_t);
int upipe_rate_limit_get_limit(struct upipe *, uint64_t *);
int upipe_rate_limit_set_duration(struct upipe *, uint64_t);
int upipe_rate_limit_get_duration(struct upipe *, uint64_t *);
